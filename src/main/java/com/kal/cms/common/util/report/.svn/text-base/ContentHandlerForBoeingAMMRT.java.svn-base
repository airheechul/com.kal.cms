...
public class ContentHandlerForBoeingAMMRT extends CustomContentHandler{
	...
	public ContentHandlerForBoeingAMMRT(DTDHandler dtdHandler, String outputPath, String csvPrefix, ReportInfo report, Writer writer){
	...
	public void endElement(String uri, String localName, String qName)
		...
		try {
			...
			if(innerTaskTitle &&  "TITLE".equalsIgnoreCase(localName)){
                ...
                String data = report.getcMODEL() + "," + rEnigma_Publish_Date + "," + rEnigma_Route_ID + "," + rRoute_No + "," + getQuotString(convertPreChars(taskTitle.replaceAll(",", ""))) + ","
		                + ",,,,,,,,,,"
		                + rDate + ","
		                + ",,,,"
		                + rSystem + ",,"
	...
	//TODO 구 VB - Boing_AMM_RT
	/* 
	Public Sub Boing_AMM_RT(ByRef Nodes As MSXML2.IXMLDOMNodeList, ByVal Indent As Integer)
	...
	'                                            "Page Block"
	    ...
	    For Each xNode In Nodes
	        ...
	        If xNode.nodeType = NODE_ELEMENT Then
	           ...
	           Select Case UCase(xNode.nodeName)
	                  ...
	                  Case "SUBTASK":
	                        ...
	                        If SUBCONFLTR = "" Then
	                            rOperation_no = "KE." & cMODEL & ".AMM." & SUBCHAPNBR & "-" & SUBSECTNBR & "-" & SUBSUBJNBR & "." & SUBFUNC & "." & SUBSEQ & "."
	                        Else
	                            rOperation_no = "KE." & cMODEL & ".AMM." & SUBCHAPNBR & "-" & SUBSECTNBR & "-" & SUBSUBJNBR & "." & SUBFUNC & "." & SUBSEQ & "." & SUBCONFLTR & SUBVARNBR
	                        End If
	        ...
	        If xNode.hasChildNodes Then   '하위노드 존재시 재호출
	           ...
	           Boing_AMM_RT xNode.childNodes, Indent
