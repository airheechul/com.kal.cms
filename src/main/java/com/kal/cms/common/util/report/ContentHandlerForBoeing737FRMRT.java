...
public class ContentHandlerForBoeing737FRMRT extends CustomContentHandler{
	...
	public ContentHandlerForBoeing737FRMRT(DTDHandler dtdHandler, String outputPath, String csvPrefix, ReportInfo report, Writer writer){
	...
	/*
	Public Sub Boing_FRM_RT_737(ByRef Nodes As MSXML2.IXMLDOMNodeList, ByVal Indent As Integer)
	...
	''                                             "Replace_Percent,ReWork_Percent,Exclude_Flag,CL_Material_Flag,Page Block"
	    ...
	    For Each xNode In Nodes
	        ...
	        If xNode.hasChildNodes Then   '하위노드 존재시 재호출
	           ...
	           Boing_FRM_RT_737 xNode.childNodes, Indent
