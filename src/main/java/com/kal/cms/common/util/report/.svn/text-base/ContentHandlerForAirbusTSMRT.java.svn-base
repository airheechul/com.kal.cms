...
public class ContentHandlerForAirbusTSMRT extends CustomContentHandler{
	...
	public ContentHandlerForAirbusTSMRT(DTDHandler dtdHandler, String outputPath, String csvPrefix, ReportInfo report, Writer writer){
	...
	public void startElement(String uri, String localName, String qName,
		...
		if(elemNameTask.equalsIgnoreCase(localName)){
			...
			if(attributes!=null){
				...
				String RN = report.getcMODEL() + "_" + tempMap.get("CHAPNBR") + "-" + tempMap.get("SECTNBR") + "-" + tempMap.get("SUBJNBR") + "-" + tempMap.get("FUNC") + "-" + tempMap.get("SEQ") + "-" + tempMap.get("CONFLTR");
	...
	public void endElement(String uri, String localName, String qName)
		...
		try {
			...
			if(innerTaskTitle &&  "TITLE".equalsIgnoreCase(localName)){
				...
				String data = report.getcMODEL() + "," + REVDATE + "," + Enigma_Key + "," + Route_No + "," +  getQuotString(convertPreChars(taskTitle)) + ","
					+ ",,,,,,,,,,"
					+ rDate + ","
					+ ",,,," 
					+ System + ",,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,";
	...
	// TODO Airbus_TSM_RT
	/*
	Public Sub Airbus_TSM_RT(ByRef Nodes As MSXML2.IXMLDOMNodeList, ByVal Indent As Integer)
	...
	''                                             "Replace_Percent,ReWork_Percent,Exclude_Flag,CL_Material_Flag,Page Block"
	    ...
	    For Each xNode In Nodes
	        ...
	        If xNode.hasChildNodes Then   '하위노드 존재시 재호출
	           ...
	           Airbus_TSM_RT xNode.childNodes, Indent
